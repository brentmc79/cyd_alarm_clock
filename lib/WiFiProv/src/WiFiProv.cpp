...
// QR code generation disabled - using custom QRCodeWidget instead
    log_i("Provisioning payload: %s", payload);
    ...
    log_i("Note: This project uses custom QR code widget for App Store URL");
}
